...
next:
  pages:
    - slug: create-secret
      ...
      type: basic
---
Static secrets are `key/value` pairs that you create and update manually, such as passwords and API tokens. You can store any text-based items in their original format, including configuration files, `JSON`, and `YAML`.
