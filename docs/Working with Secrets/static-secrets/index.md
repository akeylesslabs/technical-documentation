...
2. [Add a Static Secret to an Access Role](doc:add-a-static-secret-to-an-access-role): Enable clients to access the static secret by adding it to a role, with the appropriate permissions.
