...
To manage secrets stored on AWS Secret Manager, the **USC** uses the [AWS Target](https://docs.akeyless.io/docs/gateway-deploy-serverless-aws-targets) to establish secure logical access into the related Secret Manager, effectively letting you manage them indirectly. Each **USC** item derives its permissions from the identity linked to its [AWS Target](https://docs.akeyless.io/docs/gateway-deploy-serverless-aws-targets).
...
* [AWS Target](https://docs.akeyless.io/docs/gateway-deploy-serverless-aws-targets) which holds an AWS IAM Principal with the following permissions:
...
4. Define the remaining settings as follows:
    ...
    * **Target:** Select an existing [AWS Target](https://docs.akeyless.io/docs/gateway-deploy-serverless-aws-targets).
