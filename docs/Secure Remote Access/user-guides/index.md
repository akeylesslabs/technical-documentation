...
1. **[SRA Web Portal](https://docs.akeyless.io/docs/access-resources-remotely)** - The Web Portal is a browser-based interface that allows users to securely access resources over the web or using native CLI commands. **Ideal For**: Users who prefer a lightweight, platform-agnostic solution without installing additional software.
