...
1. **[SRA Web Portal](doc:access-resources-remotely)** - The Web Portal is a browser-based interface that allows users to securely access resources over the web or using native CLI commands. **Ideal For**: Users who prefer a lightweight, platform-agnostic solution without installing additional software.
2. **[Desktop Application](doc:remote-access-desktop-application-beta)** - The Desktop Application can be installed on local machines running Windows or Mac. It enables access to various targets using native clients such as database clients, SSH terminals, or RDP software. **Ideal For**: Users who prefer a dedicated application for accessing resources or require native client support.
