...
To revoke an existing session from your [Akeyless Gateway Overview](https://docs.akeyless.io/docs/akeyless-gateway) or your IdP like Okta, or Keycloak, enable the `sessionTermination` and set the `apiURL` to your Gateway, or to your IdP URL.
