...
next:
  description: ''
---
Akeyless Secure Remote Access is part of the [Gateway](doc:api-gw). Users can deploy Remote Access components alongside the Gateway or can use the same chart to deploy Remote Access components after the Gateway is deployed.
