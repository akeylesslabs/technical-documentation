...
The **SRA** approach requires a Gateway. If you already have an existing one, you can use it to deploy the **SRA** by updating the `values.yaml` file as follows:
