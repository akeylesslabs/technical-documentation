...
* Docker Compose: configure worker and dispatcher service DNS values in your Compose deployment and dispatcher environment settings.
...
| --- | --- | --- |
| Worker discovery | Configure Compose service DNS and dispatcher environment settings | chart-generated `WEB_WORKER_SERVICE_DNS` and `WEB_DISPATCHER_SERVICE_DNS` |
