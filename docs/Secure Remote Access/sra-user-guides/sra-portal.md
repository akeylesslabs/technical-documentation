...
3. If you are also working with [Zero Trust Web Access](https://docs.akeyless.io/docs/sra-web-access-on-k8s), set the **Web Application Dispatcher** with the URL of your `web-access-dispatcher` cluster service; the default is `9000`. If you are working with Secure Proxy, also set the **Web Proxy URL** with the `web-access-dispatcher` cluster service port; the default is `19414`.
