...
excerpt: >-
  Secure Remote Access to a MySQL, MSSQL, MongoDB, Redshift, Oracle, PostgreSQL
...
Let's set up remote access to a database using the Akeyless CLI. If you’d prefer, see how to do this from the [Akeyless Console](https://docs.akeyless.io/docs/sra-database#set-up-remote-access-to-a-database-from-the-akeyless-console) instead.
...
Let's set up remote access to a database from the Akeyless Console. If you'd prefer, see how to do this from [Akeyless CLI](https://docs.akeyless.io/docs/sra-database#set-up-remote-access-to-a-database-from-the-akeyless-cli) instead.
