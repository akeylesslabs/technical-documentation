...
With a public CA, Akeyless cannot access the private key that signs certificates. Akeyless will programmatically validate the certificate signing request by contacting Sectigo through the [Akeyless Gateway](https://docs.akeyless.io/docs/akeyless-gateway) using the domain owner's account details
