...
* [Amazon Elastic Kubernetes Service (EKS)](https://docs.akeyless.io/docs/kubernetes-plugins-plugins-targets#eks)
* [Google Kubernetes Engine (GKE)](https://docs.akeyless.io/docs/kubernetes-plugins-plugins-targets#gke)
* [Kubernetes (K8s) Generic](https://docs.akeyless.io/docs/kubernetes-plugins-plugins-targets#k8s-generic)
...
3. Select a **Protection key** with a Customer Fragment to enable Zero-Knowledge and click **Next**.
    For more information, [read about Zero-Knowledge Encryption](https://docs.akeyless.io/docs/gateway-zero-knowledge).
