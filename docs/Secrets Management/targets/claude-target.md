...
metadata:
  robots: index
---
You can define a [Claude](https://platform.claude.com/login?returnTo=%2F%3F) target to be used for [AI Insights](https://docs.akeyless.io/docs/akeyless-ai-insight) in your account.
...
4. Define the remaining parameters as follows:
   - **API Key**: The Claude API Key.
   - **Claude URL**: The endpoint for the Claude API. Default: [https://api.anthropic.com](https://api.anthropic.com "https://api.anthropic.com")
