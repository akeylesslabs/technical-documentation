...
Choose the desired mode of authenticating either **Use Credentials**, **Use Cloud Identity**, or **Target** to use a domain credentials from an existing [LDAP Target](https://docs.akeyless.io/docs/auth-with-ldap-target)
