---
title: Kubernetes Generic Dynamic Secrets
excerpt: ''
deprecated: false
hidden: false
metadata:
...
* A [Generic Kubernetes Target](https://docs.akeyless.io/docs/kubernetes-pluginss-targets#k8s-generic) or the equivalent inline credentials
...
If you haven't done so already, you can now create a [Generic Kubernetes Target](https://docs.akeyless.io/docs/kubernetes-pluginss-targets#k8s-generic) using either the GW Service Account or the dedicated Service Account (if it's a dedicated Service Account, be sure to extract its Bearer Token).

> ℹ️ **Info (Kubernetes v1.24 and above):**
>
> Starting from Kubernetes v1.24 and above, note that Service Accounts are created without tokens by default. To provide the privileged Service Account a Bearer Token for creating the [Kubernetes Generic Target](https://docs.akeyless.io/docs/kubernetes-pluginss-targets#k8s-generic), create the token manually.
...
If you haven't done so already, you can now create a [Generic Kubernetes Target](https://docs.akeyless.io/docs/kubernetes-pluginss-targets#k8s-generic) using the Client Certificate generated above.

## Dynamic Generic Kubernetes Secrets with the CLI

### Create a Dynamic Generic Kubernetes Secret

**Fixed Mode:** To create a dynamic generic Kubernetes Secret with the CLI using an existing [Kubernetes Target](https://docs.akeyless.io/docs/kubernetes-pluginss-targets#create-a-generic-kubernetes-target-from-the-cli) in **Fixed Mode**, use the following command:
...
If you don't have a configured [Kubernetes Targets](https://docs.akeyless.io/docs/kubernetes-pluginss-targets) yet, you can use the command with your Kubernetes Cluster connection strings inline:
...
4. Define the remaining parameters as follows:
    ...
    * **Target mode:** In this section, you can either select an existing [Kubernetes Target](https://docs.akeyless.io/docs/kubernetes-pluginss-targets) or specify endpoint details explicitly in the next section.
