...
When a client requests a dynamic secret value, the Akeyless Platform connects to the database through the [Gateway](https://docs.akeyless.io/docs/akeyless-gateway) within your internal network and generates a temporary set of restricted access credentials.
