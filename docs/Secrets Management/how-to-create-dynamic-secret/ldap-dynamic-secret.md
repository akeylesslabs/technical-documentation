...
next:
  description: ''
---
You can define a dynamic LDAP secret to dynamically generate LDAP access credentials. When a client requests the dynamic secret value, the [Akeyless Gateway](https://docs.akeyless.io/docs/akeyless-gateway) connects to your LDAP server and generates a temporary set of restricted access credentials.

## Prerequisites

* An [Akeyless Gateway](https://docs.akeyless.io/docs/akeyless-gateway) with network access to the LDAP server.
