...
When a client requests a Rotated Secret value, the Akeyless Platform connects to the AWS Cloud through your [Gateway](https://docs.akeyless.io/docs/akeyless-gateway) to rotate the user password on your target AWS account.
