...
When a client requests a Rotated Secret value, the Akeyless Platform connects to the SSH server through your [Gateway](https://docs.akeyless.io/docs/akeyless-gateway) to rotate the relevant credential on your target server.
