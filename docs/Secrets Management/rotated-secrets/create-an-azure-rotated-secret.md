...
When a client requests a Rotated Secret value, the Akeyless Platform connects to the Azure App through your [Gateway](https://docs.akeyless.io/docs/akeyless-gateway) to rotate the Key of the target Azure App.
