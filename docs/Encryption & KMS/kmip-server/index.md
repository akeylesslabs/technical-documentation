...
* `certificate-pending-expiration`: Triggered before certificate expiration based on configured lead time.
* `certificate-expired`: Triggered when a certificate has expired.
