...
1. Create a new [GCP Target](https://docs.akeyless.io/docs/gcp-targets) in the Akeyless Platform. You can do it either from the [Akeyless CLI](https://docs.akeyless.io/docs/gcp-targets#create-a-gcp-target-with-the-cli) or in the Akeyless Console. Make sure you have a GCP Keyring to target.
