---
title: AWS KMS
excerpt: AWS Key Management Service (AWS KMS)
deprecated: false
hidden: false
metadata:
  title: ''
...
1. Create a new [AWS Target](https://docs.akeyless.io/docs/cloud-targets) in the Akeyless Platform. You can do it either from the [Akeyless CLI](https://docs.akeyless.io/docs/cloud-targets#create-an-aws-target-from-the-cli) or in the [Akeyless Console](https://docs.akeyless.io/docs/cloud-targets#create-an-aws-target-in-the-akeyless-console).
...
You can export the key into multiple regions within AWS KMS. The default region is based on the [AWS Target](https://docs.akeyless.io/docs/cloud-targets) region. For later replication, you can set the option without specifying extra regions. For example:
