...
Note that to create a Classic Key, you must have an active gateway and the **Classic Keys** permission enabled. To set up a gateway, please go to [Akeyless Gateway Overview](https://docs.akeyless.io/docs/akeyless-gateway).
