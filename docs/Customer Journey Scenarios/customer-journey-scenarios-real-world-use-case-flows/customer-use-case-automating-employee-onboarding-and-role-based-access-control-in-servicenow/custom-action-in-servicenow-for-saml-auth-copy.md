...
![Illustration for: * To add a place where you will be able to write a script select the blue plus button. * Select script option * Place to write you script](https://files.readme.io/a0fe3a1-Screenshot_2024-03-01_at_16.54.54.png)
