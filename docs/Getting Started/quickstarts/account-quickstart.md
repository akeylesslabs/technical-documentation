...
1. Navigate to the Akeyless signup page:  
   <Anchor label="[https://console.akeyless.io/registration](https://console.akeyless.io/registration)" target="_blank" href="https://console.akeyless.io/registration">[https://console.akeyless.io/registration](https://console.akeyless.io/registration)</Anchor>
