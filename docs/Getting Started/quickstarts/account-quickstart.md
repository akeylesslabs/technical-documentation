...
metadata:
  robots: index
---
This quickstart guides you through creating a new Akeyless account, verifying your email address, and signing in to the Akeyless Console for the first time. Completing this setup is required before you can create secrets, configure gateways, or integrate Akeyless with applications.
...
1. Navigate to the Akeyless signup page:  
   **https://console.akeyless.io/signup**
...
1. Go to: **https://console.akeyless.io/**
