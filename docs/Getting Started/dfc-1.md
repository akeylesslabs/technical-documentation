...
flowchart LR
    ...
    U --> K1[KFM A<br/>Fragment A]
    U --> K2[KFM B<br/>Fragment B]
    U --> K3[KFM C<br/>Fragment C]

    G --> CF[Customer Fragment<br/>(optional)]
    ...
    KD --> O[Crypto Operation<br/>(encrypt, decrypt, sign)]
