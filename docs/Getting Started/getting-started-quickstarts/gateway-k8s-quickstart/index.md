...
> ✅ **Tip:** We have created a [Setup Kubernetes Quickstart](https://docs.akeyless.io/docs/kubernetes-plugins-plugins-setup-quickstart) to assist you if you're unfamiliar with setting up a Kubernetes cluster.
