...
Setting the [Gateway](https://docs.akeyless.io/docs/akeyless-gateway) to forward the **Audit Logs** can be configured either during deployment or after the Gateway is deployed.
