...
> ℹ️ **Note (Akeyless Gateway):**
>
> The following Actions will take place from the Gateway that has the IAM-User from the source account assigned.
>
> Make sure you have an [Akeyless Gateway](https://docs.akeyless.io/docs/akeyless-gateway) with the IAM Role from the source account attached.
