...
3. Click **Next**, then **Create Stack**.
    ...
    * Deploy the [Akeyless Gateway](https://docs.akeyless.io/docs/akeyless-gateway) inside a Docker container on the **EC2 instance** for secure, high-availability access to Akeyless Vault services.
