...
For step-by-step instructions, see [Configure LDAP gateway URL](https://docs.akeyless.io/docs/configure-ldap-gateway-url-1).

## Vault URL

The Vault URL section allows users to turn on a custom tenant or vault endpoint and provide the required URL.

For step-by-step instructions, see [Configure Custom/Specific Tenant](https://docs.akeyless.io/docs/configure-customspecific-tenant).
