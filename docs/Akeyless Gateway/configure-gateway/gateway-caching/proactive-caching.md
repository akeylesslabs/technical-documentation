...
| --- | --- |
| Gateway Console | In the Gateway UI, go to **Manage Gateway** > **Caching Configuration** and enable the **Enable Proactive Caching** toggle. (Requires **Enable Caching** to be on first.) |
