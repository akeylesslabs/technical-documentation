...
It is also possible to [configure caching](https://docs.akeyless.io/docs/gateway-caching) in the Gateway Configuration Manager after the Gateway is deployed.
