...
To work with Certificate-Based Authentication as the default login method for your Gateway, ensure your Gateway deployment is set with `sni-proxy` enabled, as described in this [guide](https://docs.akeyless.io/docs/gateway-docker-advanced-configuration#setting-a-default-login) for Docker, or for Kubernetes deployment as described in the [Helm values reference](https://docs.akeyless.io/docs/gateway-kubernetes-helm-values-reference).  
