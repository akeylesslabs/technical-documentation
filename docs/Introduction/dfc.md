...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0ef2ecb-DFC.png",
        "DFC.png",
        1238
      ],
      "align": "center",
      "sizing": "80",
      "caption": "Fragments of a single Encryption Key that are stored in <br> different cloud providers and are NEVER combined"
    }
  ]
}
[/block]
...
**_Q: So you're basically using key-split? Shamir's secret sharing?_**
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3b36cbc-CFZK.png",
        "API key auth (1).png",
        1920
      ],
      "align": "center",
      "caption": "Fragments of a single Encryption Key that are managed by Akeyless <br> while a single fragment is stored in the customer's environment"
    }
  ]
}
[/block]