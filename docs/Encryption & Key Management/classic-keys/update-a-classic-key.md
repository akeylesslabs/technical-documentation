...
[block:code]
{
  "codes": [
    {
      "code": "akeyless gateway-update-item --gateway-url <Akeyless PAI GW URL> --name <classic key name> /\n--new-name <new classic key name> /\n--new-metadata <metadata>",
      "language": "shell"
    }
  ]
}
