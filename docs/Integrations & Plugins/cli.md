...
To re-route the entire traffic directly by way of your [Gateway](https://docs.akeyless.io/docs/akeyless-gateway) for closed environments, create an environment variable `AKEYLESS_GATEWAY_URL` to point your CLI to interact with the relevant Gateway:
