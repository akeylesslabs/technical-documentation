...
excerpt: This documentation suits Node.js and React.
deprecated: false
hidden: false
metadata:
  title: ''
...
To work with Your [Gateway](https://docs.akeyless.io/docs/akeyless-gateway) set the `client.basePath` with your Gateway API endpoint on port `8081`.
