...
Instead of checking your Auth Method `access Id`, or your [Gateway](https://docs.akeyless.io/docs/akeyless-gateway) `URL` into version control, we can store them securely in CircleCI environment variables.
