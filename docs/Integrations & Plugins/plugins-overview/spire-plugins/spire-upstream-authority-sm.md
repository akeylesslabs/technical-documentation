...
* An [Authentication Method](https://docs.akeyless.io/docs/access-and-authentication-methodss) attached to a role with `Read`, `Update`, and `List` permissions on the required item path
