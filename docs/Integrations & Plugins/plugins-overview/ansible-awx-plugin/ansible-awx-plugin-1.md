...
On AWX UI, navigate to **Resources** and create new **Credentials**. Select HashiCorp Vault Secret Lookup as your **Credentials Type** and set the **SERVER URL** to `https://hvp.akeyless.io` or work directly with your [Gateway](https://docs.akeyless.io/docs/akeyless-gateway) URL on port `8200`:
