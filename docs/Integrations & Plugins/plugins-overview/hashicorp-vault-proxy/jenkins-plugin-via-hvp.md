...
4. In the **Build Environment** tab, select the **Vault Plugin** radio button. Then, enter the [Akeyless Proxy](https://docs.akeyless.io/docs/hashicorp-vault-proxy) URL: `https://hvp.akeyless.io`
    ...
    > 📘 Info
    >
    > If you are using a customer [key fragment](https://docs.akeyless.io/docs/dfc-overview) with your Akeyless Platform, set your Vault URL with the [Akeyless Gateway](https://docs.akeyless.io/docs/akeyless-gateway) on port `8200`.
