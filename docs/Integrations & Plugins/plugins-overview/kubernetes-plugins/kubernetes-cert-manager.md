...
At this stage, all the configuration for Kubernetes authentication is set and it is possible to proceed to the next step to [create the certificate request](https://docs.akeyless.io/docs/cert-manager#create-a-certificate-request).
