...
| _Secret injection method_                  | Controller reconciles `ExternalSecret` CRDs           | Mutating Admission Webhook (init and optional sidecar)      | CSI driver mounts secrets into container filesystem | Certificate issuance & renewal                    |
