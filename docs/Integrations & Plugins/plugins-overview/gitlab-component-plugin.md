...
In this guide, we will use [OAuth 2.0 / JWT](https://docs.akeyless.io/docs/auth-with-oauth-jwt) **Auth Method** to work with the plugin but you can use any [Authentication Method](https://docs.akeyless.io/docs/access-and-authentication-methods) that is listed in the **Usage** section below.
