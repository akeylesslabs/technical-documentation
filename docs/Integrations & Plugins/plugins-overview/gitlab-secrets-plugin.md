...
Where the `cert_user_name` value should match the [SSH Issuer](https://docs.akeyless.io/docs/sra-ssh) allowed username list. Should be provided with a `public_key_data` to issue the certificate.
