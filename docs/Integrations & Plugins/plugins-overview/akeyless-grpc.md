...
To work with **gRPC** clients make sure your [Gateway](https://docs.akeyless.io/docs/akeyless-gateway) runs on version `4.14` or higher. The **gRPC** runs on Gateway port `8085`.
