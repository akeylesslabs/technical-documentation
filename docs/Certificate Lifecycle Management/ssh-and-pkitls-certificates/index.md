---
title: ssh-and-pkitls-certificates
excerpt: ''
deprecated: false
hidden: false
metadata:
...
Akeyless can act as a Certificate Authority (CA) for the internal environment. This page focuses on PKI Cert Issuer, [read more about how to create and work with SSH certificates](https://docs.akeyless.io/docs/sra-ssh-certificates).
