...
Let's create a [DFC Key](https://docs.akeyless.io/docs/gateway-zero-knowledge#create-dfc-key-from-the-akeyless-console) for our **PKI Cert Issuer** with a self-signed certificate, first let's create the **CSR** conf file:
