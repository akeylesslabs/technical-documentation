...
Any [stored](https://docs.akeyless.io/docs/certificate-storage) certificate can be provisioned through the [Gateway](https://docs.akeyless.io/docs/akeyless-gateway), whereupon successful provisioning, future renewals of the certificate will be provisioned automatically.
